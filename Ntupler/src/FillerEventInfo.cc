...
FillerEventInfo::FillerEventInfo(const edm::ParameterSet &iConfig, const bool useAOD,edm::ConsumesCollector && iC):
    ...
    fUseMET        (iConfig.getUntrackedParameter<bool>("doFillMET",true)),
    fUseAOD        (useAOD),
    fPrefWeightName     (iConfig.getUntrackedParameter<edm::InputTag>("ecalWeightName")),
    fPrefWeightUpName   (iConfig.getUntrackedParameter<edm::InputTag>("ecalWeightUpName")),
    fPrefWeightDownName (iConfig.getUntrackedParameter<edm::InputTag>("ecalWeightDownName"))
{
    ...
    fTokPrefWeight      = iC.consumes<double>                           (fPrefWeightName);
    fTokPrefWeightUp    = iC.consumes<double>                           (fPrefWeightUpName);
    fTokPrefWeightDown  = iC.consumes<double>                           (fPrefWeightDownName);
